        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                {/* modal */}
                <Dialog.Panel className="w-[20rem] max-w-md transform overflow-hidden rounded-2xl bg-white/30 backdrop-blur-sm p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
